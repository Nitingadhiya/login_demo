...
class LineHeight {
  ...
  static double lh26(fs) => 26 / fs;
  static double lh24(fs) => 24 / fs;
  static double lh22(fs) => 22 / fs;
  static double lh20(fs) => 20 / fs;
  static double lh18(fs) => 18 / fs;
  static double lh14(fs) => 14 / fs;
}
